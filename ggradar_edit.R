##Funkcja z https://github.com/ricardo-bion/ggradar
##Zmieniona pozycja legendy, wielkość tytułu i marginesu
ggradar <- function (plot.data, font.radar = "Circular Air Light", values.radar = c("0%", 
          ...
          legend.text.size = grid.label.size) 
{
  ...
  base <- base + theme(legend.key.width = unit(3, "line")) + 
    ...
    theme(legend.text = element_text(size = legend.text.size), 
          plot.title = element_text(size = 25, hjust = 0.5, margin= margin(b = 1)),
